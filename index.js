import{a as m,S as p,i as d}from"./assets/vendor-BK_rxH-O.js";(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const e of document.querySelectorAll('link[rel="modulepreload"]'))o(e);new MutationObserver(e=>{for(const r of e)if(r.type==="childList")for(const a of r.addedNodes)a.tagName==="LINK"&&a.rel==="modulepreload"&&o(a)}).observe(document,{childList:!0,subtree:!0});function i(e){const r={};return e.integrity&&(r.integrity=e.integrity),e.referrerPolicy&&(r.referrerPolicy=e.referrerPolicy),e.crossOrigin==="use-credentials"?r.credentials="include":e.crossOrigin==="anonymous"?r.credentials="omit":r.credentials="same-origin",r}function o(e){if(e.ep)return;e.ep=!0;const r=i(e);fetch(e.href,r)}})();m.defaults.baseURL="https://pixabay.com/api/";function h(s){return m.get("",{params:{key:"51819107-ec467fcdcf3190bdaabfbeda8",q:s,image_type:"photo",orientation:"horizontal",safesearch:!0}})}let c=null;function y(s){document.querySelector(".gallery").innerHTML=s.map(t=>`<li class="gallery-item">
                ...
                </li>`).join(""),c?c.refresh():c=new p(".gallery a")}function g(){document.querySelector(".gallery").innerHTML=""}function b(){document.getElementById("the-loader").classList.add("loader")}function l(){document.getElementById("the-loader").classList.remove("loader")}l();const f=document.querySelector(".form"),u=document.querySelector('input[name="search-text"]'),n=document.querySelector("button");n.disabled=!0;u.addEventListener("input",s=>{u.value.trim()===""?n.disabled=!0:n.disabled=!1});f.addEventListener("submit",s=>{b(),s.preventDefault(),g();const t=u.value.trim();h(t).then(i=>{const o=i.data.hits;o.length===0?(l(),d.warning({title:":(",message:"So sad, nothing found",position:"topRight"}),f.reset(),n.disabled=!0):(y(o),l())}).catch(i=>{d.warning({title:"OH MY GOD, SOMETHING WENT WRONG!",message:`${i}`,position:"topRight"}),l()})});
